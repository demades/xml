...
a persistence unit "xmlPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/lu/uni/exercises/jakarta/xml/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "xml/pom.xml":
...
artifact ("xml.war") is already built. You can build
